        ...
        <div className="container px-4 md:px-6 relative z-10">
          <Tabs defaultValue="get-involved" className="w-full">
            <div className="sticky top-0 z-10 pb-4">
              <TabsList className="flex flex-col w-full gap-2 md:flex-row md:justify-center">
                <TabsTrigger 
                  value="get-involved" 
                  className="w-full md:flex-1 min-w-0 text-base sm:text-lg whitespace-nowrap overflow-hidden text-ellipsis px-4 py-2"
                >
                  Get Involved
                </TabsTrigger>
                <TabsTrigger 
                        ...
                        <div className="space-y-4">
                          ...
                          <ul className="space-y-2">
                            ...
                            <li className="flex items-center gap-2">
                              ...
                              <span className="text-zinc-600 dark:text-zinc-600">Grades 6th+</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="bg-primary/10 rounded-full p-1">
                                <GiPalmTree className="h-4 w-4 text-primary" />
                              </div>
                              <span className="text-zinc-600 dark:text-zinc-600">Willing to commit at least 1 hour a month</span>
                            </li>
                            <li className="flex items-center gap-2">
                              <div className="bg-primary/10 rounded-full p-1">
                                <GiPalmTree className="h-4 w-4 text-primary" />
              ...
              <TabsContent value="contact">
                <div className="space-y-8 text-center">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mx-auto max-w-4xl">
                    <Card className="nature-card p-6 flex flex-col items-center gap-4 group hover:bg-secondary/10 transition-colors duration-300">
                      <FaEnvelope className="h-16 w-16 text-secondary" />
                    ...
                    <Card className="nature-card p-6 flex flex-col items-center gap-4 group hover:bg-secondary/10 transition-colors duration-300">
                      <FaInstagram className="h-16 w-16 text-secondary" />
